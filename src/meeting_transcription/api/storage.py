...
class MeetingStorage:
    ...
    def __init__(
        ...
        # Report storage mode
        if self.db:
            print("📊 Meeting state: Firestore")
        else:
            print("📊 Meeting state: Local JSON files")
    ...
    def update_meeting(self, meeting_id: str, updates: dict) -> dict | None:
        """
    ...
    def _load_local_meeting(self, meeting_id: str) -> dict | None:
    ...
    def get_download_url(self, meeting_id: str, filename: str, expires_minutes: int = 60) -> str | None:
        """
